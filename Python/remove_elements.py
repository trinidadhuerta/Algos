...
# Using two pointers and a counter, we can iterate only once through the array, 
# The first pointer points to the last good index, and the second points to the next value to keep in the array and swap to the last good index
